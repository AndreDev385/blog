import { c as createComponent, r as renderTemplate, a as renderComponent, b as createAstro, m as maybeRenderHead, d as addAttribute } from '../../chunks/astro/server_C1k3jRZ-.mjs';
import { C as Card, a as CardHeader, b as CardContent, $ as $$SkillBadge, s as skillIconMap } from '../../chunks/skillIconMap_8ibTACD0.mjs';
import { $ as $$Image } from '../../chunks/_astro_assets_NLTBK9sq.mjs';
import { $ as $$Layout } from '../../chunks/utils_DypuczZx.mjs';
...
const $$tag = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="lg:hidden md:flex flex-wrap gap-2 p-2 border mt-4 bg-white"> ${tags.map((currTag) => renderTemplate`${renderComponent($$result2, "TagComponent", Tag, { "tag": currTag, "selected": tag === currTag })}`)} </div> <div class="max-w-6xl flex flex-col px-6 md:px-4 lg:px-2 lg:flex-row gap-8 mx-auto mt-4"> <div class="lg:w-4/5"> <ul class="space-y-6 flex justify-center align-center flex-col"> ${posts.map((post) => renderTemplate`${renderComponent($$result2, "PostCard", $$PostCard, { "post": post })}`)} </ul> </div> <aside class="lg:w-1/5 hidden lg:block flex-shrink-0"> <ul class="space-y-2"> ${tags.map((currTag) => renderTemplate`<li> ${renderComponent($$result2, "TagComponent", Tag, { "tag": currTag, "selected": tag === currTag })} </li>`)} </ul> </aside> </div> ` })}`;
