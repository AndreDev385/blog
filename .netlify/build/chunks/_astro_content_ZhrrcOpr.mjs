import { r as removeBase, i as isRemotePath, V as VALID_INPUT_FORMATS, p as prependForwardSlash } from './consts_BTZ1hbw_.mjs';
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, f as renderUniqueStylesheet, g as renderScriptElement, h as createHeadAndContent, r as renderTemplate, a as renderComponent, u as unescapeHTML } from './astro/server_C1k3jRZ-.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CIYsI4oc.mjs');
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/blog/create-a-blog-with-astro-&-markdown.md": () => import('./create-a-blog-with-astro-_-markdown_CRt9HqRU.mjs')});
...
let lookupMap = {};
lookupMap = {"blog":{"type":"content","entries":{"create-a-blog-with-astro--markdown":"/src/content/blog/create-a-blog-with-astro-&-markdown.md"}}};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/blog/create-a-blog-with-astro-&-markdown.md": () => import('./create-a-blog-with-astro-_-markdown_BG0RPonH.mjs')});
